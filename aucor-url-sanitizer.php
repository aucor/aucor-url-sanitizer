...
Plugin URI: https://github.com/aucor/aucor-url-sanitizer
...
function aucor_url_sanitizer_sanitize_title($title) {
  ...
  /**
   * Step 1: Make dictionary for search & replace
   */
   ...
   */
  $title = strtr($title, apply_filters('aucor_url_sanitizer_table', $char_map));

  /**
   * Step 2: Make whole new dictionary for Chinese characters
   *
   * Going through Chinese characters can produce really long slugs
   * so we'll need to concate it if it gets out of hand.
   *
  ...
  $slug_length = apply_filters('aucor_url_sanitizer_slug_length', 100);
